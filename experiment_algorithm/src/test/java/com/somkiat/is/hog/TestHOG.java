package com.somkiat.is.hog;

import hog.BlocksComputation;
import hog.DescriptorComputation;
import hog.Detector;
import hog.GradientsComputation;
import hog.HOG;
import hog.HOG_Factory;
import hog.HistogramsComputation;
import hog.Hog_Printer;
import hog.L2_Norm;
import hog.MagnitudeItselfVoter;
import hog.Norm;
import hog.Point_3D;
import hog.Voter;
...
public class TestHOG extends PApplet {

	public static void main(String[] args) {
		
		TestHOG p = new TestHOG();
		p.test();
